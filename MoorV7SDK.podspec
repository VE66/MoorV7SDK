#
#  Be sure to run `pod spec lint MoorV7SDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "VE66"
  # spec.authors            = { "VE66" => "942914231@qq.com" }
  # spec.social_media_url   = "https://twitter.com/VE66"
